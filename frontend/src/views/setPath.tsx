...
const SetPathView = () => {
  ...
  return (
    <div className="flex flex-col justify-center place-items-center min-h-screen p-2 font-funnel bg-gradient-to-tr from-yellow-50 to-white text-slate-700">
      ...
      />
      <button
        className="p-2 bg-orange-300 font-bold text-white rounded-lg mt-2 w-1/4 disabled:bg-orange-100 disabled:cursor-not-allowed disabled:text-slate-500"
        disabled={!path}
